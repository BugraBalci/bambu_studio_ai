@echo off
REM ============================================================================
REM  Bambu AI Studio — one-click Windows launcher (same app as Linux start_app.sh)
...
REM
REM  Uses cmd.exe + npm.cmd (not PowerShell npm.ps1) to avoid PSSecurityException.
REM ============================================================================
...
REM call npm.cmd via cmd.exe — do not use PowerShell npm.ps1.
